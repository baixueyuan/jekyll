...
library(ReporteRs)
if (Sys.info()[1]=='Windows') pre <- 'D:'
if (Sys.info()[1]=='Darwin') pre <- '/Users/baixueyuan'
doc <- docx(template=paste(pre, '/Dropbox/R/Projects/Blogpost/templateInSimplifiedChinese.docx', sep=''))
```
