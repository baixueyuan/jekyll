...
```{r, echo=FALSE, cache=TRUE, cache.path='jekyll/_rmd/cache/', include=FALSE}
...
```{r quantm, echo=FALSE, fig.path='jekyll/figure/', render_jekyll=TRUE, fig.show='hide', addfile=TRUE}
chartSeries(GS)
```
...
```{r cars, echo=FALSE, fig.path='jekyll/figure/', render_jekyll=TRUE, fig.show='hide', addfile=TRUE}
plot(cars)
```
...
```{r unrate, echo=FALSE, warning=FALSE, render_jekyll=TRUE, fig.path='jekyll/figure/', fig.height=4, fig.width=8, dev.args=list(bg='yellow', pointsize=10), fig.show='hide', addfile=TRUE}
par(bg = 'white')
